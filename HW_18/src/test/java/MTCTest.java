...
@Epic("Тестирование веб-сайта МТС")
@Feature("Основной функционал сайта")
@Owner("Botalov A.A.")
public class MTCTest {
    ...
    @Test
    @Story("Проверка отображения блока")
    ...
    @Test
    @Story("Проверка placeholder'ов для категорий")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test
    @Story("Заполнение полей и проверка модального окна")
